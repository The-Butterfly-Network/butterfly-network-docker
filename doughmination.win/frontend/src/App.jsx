    ...
    <div className="flex flex-col min-h-screen max-w-6xl mx-auto text-black dark:text-white">
      ...
      <footer className="github-footer">
        <div className="flex flex-col items-center gap-2">
          <a href="https://github.com/The-Butterfly-Network/butterfly-network-docker/tree/main/doughminationsystem.win" target="_blank" rel="noopener noreferrer" className="github-button">
